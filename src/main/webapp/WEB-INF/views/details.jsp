...
<div class="container nav-next-element" style="border: 1px solid #dcdcdc;padding-top: 30px;padding-bottom: 30px;">
    ...
    <div class="col-md-offset-1" style="padding-top: 36px;">
        ...
        <p id="describes" style="float: left;font-size: 12px;color: #575656;line-height: 40px;">
        </p>
    ...
    <div class="col-md-offset-1" style="padding-top: 36px;">
        ...
        <p id="requires" style="float: left;font-size: 12px;color: #575656;line-height: 40px;">
        </p>
        <div style="clear: both;"></div>
    </div>
</div>
